...
<body>
    ...
    <!-- Header-->
    <header>
        <div class="container_imgCarrito">
            ...
            <div class="row">
                ...
                <div class="col-md-5 ms-auto">
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <a href="../index.php" class="btn btn-warning"><button class="btn btn-warning" type="button" id="btnVaciar">Vaciar Carrito</button></a>
                    </div>
                </div>
            </div>
        </div>
  ...
  ?>
    ...
    <!-- Core theme JS-->
    <script src="/pagina/assets/js/jquery-3.6.0.min.js"></script>
    <script src="https://www.paypal.com/sdk/js?client-id=<?php echo CLIENT_ID; ?>&locale=<?php echo LOCALE; ?>"></script>
    <script src="/pagina/assets/js/scripts.js"></script>
    <script>
        mostrarCarrito();
