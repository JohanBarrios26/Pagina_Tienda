    ...
    <div id="my_slider" class="carousel slide" data-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <div class="row">
            <div class="col-sm-12">
              <h1 class="banner_taital">TU TIENDA VIRTUAL <br> DE COFIANZA</h1>
              </div>
          </div>
        </div>
        <div class="carousel-item">
          <div class="row">
            <div class="col-sm-12">
              <h1 class="banner_taital">TODO EN LINEA <br>SIEMPRE EN LINEA</h1>
              </div>
          </div>
        </div>
        <div class="carousel-item">
          <div class="row">
            <div class="col-sm-12">
              <h1 class="banner_taital">ESTILO SIN LIMITES <br>COMPRA AHORA</h1>
              </div>
          </div>
        </div>
      </div>
